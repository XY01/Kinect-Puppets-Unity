    ...
    SubShader {
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                ...
                float4 node_2 = tex2D(_MainTex,TRANSFORM_TEX(node_22.rg, _MainTex));
                clip(node_2.a - 0.5);
////// Lighting:
////// Emissive:
...
/// Final Color:
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                ...
                float4 node_2 = tex2D(_MainTex,TRANSFORM_TEX(node_23.rg, _MainTex));
                clip(node_2.a - 0.5);
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                ...
                float4 node_2 = tex2D(_MainTex,TRANSFORM_TEX(node_24.rg, _MainTex));
                clip(node_2.a - 0.5);
